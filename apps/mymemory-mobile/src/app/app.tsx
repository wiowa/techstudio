...
import type { MatchConfig, Player as MatchPlayer, RoundResult, GridSize } from '../types/match';
...
export function App() {
  ...
  return (
    <div className="min-h-screen max-h-screen bg-background py-4 px-2 overflow-x-hidden">
      <div className="container mx-auto max-w-lg">
        {/* Mode Selection */}
        {!gameMode && (
          <div className="flex items-center justify-center min-h-[80vh]">
            <Card className="bg-card text-card-foreground backdrop-blur-md rounded-2xl shadow-2xl p-6 text-center w-full">
              <h1 className="text-3xl font-bold text-primary mb-3 drop-shadow-lg">
                Memory Game
              </h1>
              <p className="text-sm text-muted-foreground mb-4">Mobile Edition</p>
        ...
        {gameMode && cards.length > 0 && (
          <>
            ...
            <div className="text-center mb-4">
              <h1 className="text-2xl font-bold text-primary mb-2 drop-shadow-lg">
                Memory Game
              </h1>
              ...
              <p className="text-base text-secondary-foreground mb-3">
                {gameMode === 'two-player' || gameMode === 'two-player-match'
                  ? `${players[currentPlayer].name}'s Turn`
                  : `Match all ${GRID_CONFIGS[gridSize].pairCount} pairs!`}
              </p>

              {/* Stats */}
              {gameMode === 'single' && (
                <div className="flex justify-center gap-4 mb-3">
                  <Card className="bg-card text-card-foreground backdrop-blur-sm rounded-lg px-4 py-2">
                    <div className="text-xl font-bold">{moves}</div>
                    <div className="text-xs">Moves</div>
                  </Card>
                  <Card className="bg-card backdrop-blur-sm rounded-lg px-4 py-2">
                ...
                <div className="flex justify-center gap-4 mb-3">
                  {players.map((player, idx) => (
                    <Card
                      key={idx}
                      className={`
                       bg-card text-card-foreground backdrop-blur-sm rounded-lg px-4 py-2
