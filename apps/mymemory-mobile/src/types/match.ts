...
/**
 * Grid size options for the memory game
 */
...
export const STORAGE_KEYS = {
  CURRENT_MATCH: 'mymemory-mobile:currentMatch',
  MATCH_HISTORY: 'mymemory-mobile:matchHistory',
  PLAYER_STATS: 'mymemory-mobile:playerStats',
} as const;
